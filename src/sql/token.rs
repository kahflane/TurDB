...
impl Keyword {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Keyword::MacAddr => "MACADDR",
            Keyword::Inet => "INET",
            Keyword::Int4Range => "INT4RANGE",
            Keyword::Int8Range => "INT8RANGE",
            Keyword::DateRange => "DATERANGE",
            Keyword::TsRange => "TSRANGE",
            ...
            Keyword::BigSerial => "BIGSERIAL",
            Keyword::SmallSerial => "SMALLSERIAL",
