...
const TURDB_TARGET: &str =
    "/Users/julfikar/Documents/PassionFruit.nosync/turdb/turdb-core/.worktrees/single_insert_turdb";
...
fn benchmark_single_inserts() {
    ...
    println!("\n============================================================");
    println!(
        "  Single Insert Benchmark (Apple-to-Apple) - {} rows",
        ROW_COUNT
    );
    println!("============================================================\n");
    ...
    println!(
        "TurDB (PreparedStatement): {:.3}s ({:.0} rows/sec)",
        turdb_elapsed.as_secs_f64(),
        test_data.len() as f64 / turdb_elapsed.as_secs_f64()
    );
